...
object ChunkStates {
     ...
     */
    val EMPTY = key(ResourceKey.minecraft("empty"))
     ...
     */
    val ENTITIES_SPAWNED = key(ResourceKey.minecraft("entities_spawned"))
     ...
     */
    val FINALIZED = key(ResourceKey.minecraft("finalized"))
     ...
     */
    val LIT = key(ResourceKey.minecraft("lit"))
     ...
     */
    val WORLD_READY = key(ResourceKey.minecraft("world_ready"))

    private fun key(resourceKey: ResourceKey): DefaultedRegistryReference<ChunkState> =
            RegistryKey(RegistryTypes.CHUNK_STATE, resourceKey).asDefaultedReference { Karbon.game.registries }
}