...
import com.karbonpowered.api.world.volume.archetype.ArchetypeVolume
...
import com.karbonpowered.math.vector.*
...
class KarbonWorld : BaseComponentOwner(), ServerWorld {
    ...
    override fun chunkAtBlock(blockPosition: IntVector3, loadOption: WorldLoadOption): Chunk {
        TODO("Not yet implemented")
    }

    override fun chunkAtBlock(bx: Int, by: Int, bz: Int, loadOption: WorldLoadOption): Chunk {
        TODO("Not yet implemented")
    }
    ...
    override fun hasBlockState(x: Int, y: Int, z: Int, predicate: (BlockState) -> Boolean): Boolean {
        TODO("Not yet implemented")
    }
    ...
    override fun location(position: IntVector3): ServerLocation {
        TODO("Not yet implemented")
    }

    override fun location(position: DoubleVector3): ServerLocation {
        TODO("Not yet implemented")
    }

    override fun createArchetypeVolume(min: IntVector3, max: IntVector3, origin: IntVector3): ArchetypeVolume {
        TODO("Not yet implemented")
    }
